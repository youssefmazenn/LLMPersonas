...
const ChatBox = ({ selectedModel, apiKey, persona, customPrompt })=>{
    ...
    const handleSendMessageFromChatBox = async (messageToSend)=>{
        ...
        setIsLoading(true);
        const userMsg = `👤 You: ${messageToSend}`;
        ...
        try {
            ...
            const responseTextPrefix = `🧠 ${selectedModel}: `;
            if (!res.ok) {
                ...
                setMessages((prevMessages)=>{
                    ...
                    if (newMessages.length > 0 && newMessages[newMessages.length - 1].includes("Thinking...")) {
                        newMessages[newMessages.length - 1] = `⚠️ ${errorMsg}`;
                    } else {
                        newMessages.push(`⚠️ ${errorMsg}`); // Fallback if "Thinking..." not found
                    }
                    return newMessages;
                });
                setIsLoading(false);
            ...
            setMessages((prevMessages)=>{
                ...
                if (newMessages.length > 0 && newMessages[newMessages.length - 1].includes("Thinking...")) {
                    newMessages[newMessages.length - 1] = `⚠️ Network error. Could not reach the server.`;
                } else {
                    newMessages.push(`⚠️ Network error. Could not reach the server.`);
                }
                return newMessages;
            });
        } finally{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: [
                    messages.map((msg, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                        ...
                        ${msg.startsWith('👤') ? 'bg-indigo-500 text-white self-end ml-auto rounded-br-none' : 'bg-slate-100 text-slate-800 self-start mr-auto rounded-bl-none'}`,
                            children: msg.startsWith('👤 You: ') ? msg.substring('👤 You: '.length) : msg.startsWith(`🧠 ${selectedModel}: `) ? msg.substring(`🧠 ${selectedModel}: `.length) : msg.startsWith('⚠️ ') ? msg.substring('⚠️ '.length) : msg
                        }, i, false, {
                            fileName: "[project]/components/ChatBox.tsx",
                            lineNumber: 179,
                            columnNumber: 11
